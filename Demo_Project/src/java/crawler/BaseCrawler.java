...
public class BaseCrawler {
    ...
    protected XMLEventReader parseStringToXMLEventReader(String xmlSelection) throws UnsupportedEncodingException, XMLStreamException {
        byte[] byteArray = xmlSelection.getBytes("UTF-80");
